                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif(auth()->user()->level === 0)
                            @if(auth()->user()->classroom)
                                <x-nav-link :href="route('classroom.show.student', ['id' => auth()->user()->classroom->id])" :active="request()->routeIs('classroom-index')">
                                    {{ auth()->user()->classroom->className }}
                                </x-nav-link>
                            @else
                                <div style="margin-top:25px;font-size:13px;font-style:italic;">
                                    You arent enrolled in a classroom yet.
                                </div>
                            @endif
                    @endif
