...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/all-students', [UserController::class, 'show'])->name('students.index');

    Route::delete('/students/{user}', [UserController::class, 'destroy'])->name('delete.user');

    Route::get('/teachers', [UserController::class, 'showAllTeachers'])->name('teachers.index');

    Route::post('/teacher/{student}', [UserController::class, 'makeTeacher'])->name('make.teacher');

    Route::get('/all-classrooms', [ClassroomController::class, 'showAllClassrooms'])->name('classrooms.index');
